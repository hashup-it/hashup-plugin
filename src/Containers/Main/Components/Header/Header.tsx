...
export const Header = forwardRef<StackProps, 'div'>(({ children, ...rest }, ref) => (
    <HStack boxShadow="0 0 10px rgba(255,255,255,0.3)" ref={ref} p=".5rem .5rem .5rem 1rem" bg={theme.colors.black}
            borderRight={`2px solid #FF3F3F`} alignSelf="flex-end" h="48px" {...rest}>
